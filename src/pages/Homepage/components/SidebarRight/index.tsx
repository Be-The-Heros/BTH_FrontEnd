      ...
      {orgs.map((org, index)=>{ 
        ...
        <div className='sidebar_group' key={index}>
          <Link to="" className='sidebar_group_detail'>
            <FcConferenceCall style={{ fontSize: '3rem', marginTop: '-5px' }} />
            <div className='sidebar_group_detail_name'>
              {org.name}
              <p>
                <IoLocationOutline style={{marginBottom:'0.2rem'}}/> {org.address}
              </p>
            </div>
          </Link>
          <div className='sidebar_group_rate'>
            <div style={{ textAlign: 'center' }}>
              5 <AiOutlineStar style={{ fontSize: '1.1rem', marginBottom:'0.2rem' }} />
            </div>
